...
const returnTypeHelper = require("./returnTypeHelper");
...
module.exports.registerHelpers = function RegisterHelpers() {
    ...
    Handlebars.registerHelper("getFunctionReturnType", function (operation) {
        var returnTypeName = returnTypeHelper.GetFunctionReturnType(operation);
        if (returnTypeName) {
            return new Handlebars.SafeString(returnTypeName);
        } else {
            return "void";
        }
    });

    Handlebars.registerHelper("getFunctionReturn", function (operation) {
        var returnString = returnTypeHelper.GetFunctionReturn(operation);
        if (returnString) {
